...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='PEMS08_96_12', help='A unique identifier for the experiment.')
    parser.add_argument('--model', type=str, default='CasuaLNN', help='Model name, e.g., CasuaLNN, iTransformer, PatchTST.')
    ...
    parser.add_argument('--root_path', type=str, default='./dataset/PEMS/', help='Root directory of the data file.')
    parser.add_argument('--data_path', type=str, default='PEMS08_714.npz', help='Name of the data file (e.g., PEMS08_714.npz).')
    ...
    parser.add_argument('--label_len', type=int, default=48, help='Start token length for the decoder (used in models like Autoformer).')
    parser.add_argument('--pred_len', type=int, default=12, help='Prediction horizon, the length of the forecast sequence.')
    ...
    # =====================================================================================
    parser.add_argument('--d_model', type=int, default=512, help='Dimension of the model\'s hidden states.')
    parser.add_argument('--d_ff', type=int, default=2048, help='Dimension of the feed-forward network\'s intermediate layer.')
    parser.add_argument('--enc_in', type=int, default=170, help='Input size for the encoder (number of features/variables).')
    parser.add_argument('--dec_in', type=int, default=170, help='Input size for the decoder.')
    parser.add_argument('--c_out', type=int, default=170, help='Output size (number of target variables).')
    ...
    parser.add_argument('--decomp_method', type=str, default='dft_decomp', help='Series decomposition method. Options: [moving_avg, dft_decomp].')
    parser.add_argument('--moving_avg', type=int, default=25, help='Window size for the moving average decomposition.')
    parser.add_argument('--down_sampling_layers', type=int, default=2, help='Number of down-sampling layers (determines the number of scales).')
    ...
    # --- Causal Attention Specific (from v21) ---
