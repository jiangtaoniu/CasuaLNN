...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='ETTh2_96_96', help='A unique identifier for the experiment.')
    ...
    # 2. Data Loader Setup
    # =====================================================================================
    parser.add_argument('--data', type=str, default='ETTh2', help='Dataset name.')
    parser.add_argument('--root_path', type=str, default='./dataset/ETT/', help='Root directory of the data file.')
    parser.add_argument('--data_path', type=str, default='ETTh2.csv', help='Name of the data file.')
