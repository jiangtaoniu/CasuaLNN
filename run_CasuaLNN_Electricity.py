...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='ECL_96_96', help='A unique identifier for the experiment.')
    ...
    # 2. Data Loader Setup
    # =====================================================================================
    parser.add_argument('--data', type=str, default='custom', help='Dataset type (use "custom" for this dataset).')
    parser.add_argument('--root_path', type=str, default='./dataset/electricity/', help='Root directory of the data file.')
    parser.add_argument('--data_path', type=str, default='electricity.csv', help='Name of the data file.')
    ...
    # =====================================================================================
    parser.add_argument('--d_model', type=int, default=16, help='Dimension of the model\'s hidden states.')
    parser.add_argument('--d_ff', type=int, default=32, help='Dimension of the feed-forward network\'s intermediate layer.')
    parser.add_argument('--enc_in', type=int, default=321, help='Input size for the encoder (number of features/variables).')
    parser.add_argument('--dec_in', type=int, default=321, help='Input size for the decoder.')
    parser.add_argument('--c_out', type=int, default=321, help='Output size (number of target variables).')
    ...
    parser.add_argument('--e_layers_pdm', type=int, default=1,
                        help='Number of layers in the PDM block or TemporalEncoder.')
    ...
    parser.add_argument('--channel_independence', type=int, default=0,
                        help='0 for channel-dependent, 1 for channel-independent models.')
    ...
    parser.add_argument('--node_dim', type=int, default=10, help='[GNN-based] Node embedding dimension.')
    parser.add_argument('--p_hidden_dims', type=int, nargs='+', default=[128, 128],
                        help='[Stationary] Projector hidden dimensions.')
    parser.add_argument('--p_hidden_layers', type=int, default=2, help='[Stationary] Number of projector hidden layers.')
    parser.add_argument('--fusion_method', type=str, default='cross_attention', help='(Custom Model) Spatio-temporal feature fusion method.')
