...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='ETTm1_96_96', # <-- [修改]
    ...
    # =====================================================================================
    parser.add_argument('--data', type=str, default='ETTm1', help='数据集类型') # <-- [修改]
    parser.add_argument('--root_path', type=str, default='./dataset/ETT/', help='数据文件根目录') # <-- [修改]
    parser.add_argument('--data_path', type=str, default='ETTm1.csv', help='数据文件名') # <-- [修改]
