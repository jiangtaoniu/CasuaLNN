...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='Traffic_96_96', help='A unique identifier for the experiment.')
    ...
    parser.add_argument('--root_path', type=str, default='./dataset/traffic/', help='Root directory of the data file.')
    parser.add_argument('--data_path', type=str, default='traffic.csv', help='Name of the data file.')
    ...
    parser.add_argument('--d_ff', type=int, default=64, help='Dimension of the feed-forward network\'s intermediate layer.')
    parser.add_argument('--enc_in', type=int, default=862, help='Input size for the encoder (number of features/variables).')
    parser.add_argument('--dec_in', type=int, default=862, help='Input size for the decoder.')
    parser.add_argument('--c_out', type=int, default=862, help='Output size (number of target variables).')
