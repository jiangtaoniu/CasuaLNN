...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='weather_96_96', help='实验的唯一标识符')
    ...
    parser.add_argument('--root_path', type=str, default='./dataset/weather/', help='数据文件根目录')
    parser.add_argument('--data_path', type=str, default='weather.csv', help='数据文件名')
    ...
    # 4. 模型架构通用设置
    parser.add_argument('--d_model', type=int, default=16, help='模型隐藏维度')
    parser.add_argument('--d_ff', type=int, default=32, help='前馈网络中间层维度')
    parser.add_argument('--enc_in', type=int, default=21, help='编码器输入尺寸 (特征/变量数)')
    parser.add_argument('--dec_in', type=int, default=21, help='解码器输入尺寸 (兼容部分旧模型)')
    parser.add_argument('--c_out', type=int, default=21, help='输出尺寸')
    ...
    parser.add_argument('--patience', type=int, default=10, help='早停法耐心轮数')
    ...
    parser.add_argument('--use_dtw', action='store_true', default=False, help='是否在评估中额外计算DTW度量')
