...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='weather_96_96', help='A unique identifier for the experiment.')
    ...
    parser.add_argument('--root_path', type=str, default='./dataset/weather/', help='Root directory of the data file.')
    parser.add_argument('--data_path', type=str, default='weather.csv', help='Name of the data file.')
    ...
    parser.add_argument('--enc_in', type=int, default=21, help='Input size for the encoder (number of features/variables).')
    parser.add_argument('--dec_in', type=int, default=21, help='Input size for the decoder.')
    parser.add_argument('--c_out', type=int, default=21, help='Output size (number of target variables).')
