...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='PEMS08_96_12',
    ...
    parser.add_argument('--label_len', type=int, default=48, help='解码器起始Token长度 (用于Autoformer等模型)')
    ...
    parser.add_argument('--dec_in', type=int, default=170, help='解码器输入尺寸 (恢复此参数以兼容旧模型)')
    ...
    parser.add_argument('--down_sampling_layers', type=int, default=2, help='降采样层数 (决定了尺度数量)')
